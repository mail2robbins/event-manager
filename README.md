...
#MONGODB
MONGODB_URI=mongodb+srv://roamingroutestours:<password>@clusterrobbie.1v38rx2.mongodb.net/?retryWrites=true&w=majority
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "hero-img": "url('/assets/images/eventmgr.jpg')",
      },
      borderRadius: {
        lg: "var(--radius)",
